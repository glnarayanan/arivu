...
- Extension selected-text saves create quote annotations through the extension audience route, popup saves can include quick notes and manual tags, and self-hosted origins can be granted through popup settings instead of manifest edits.
