...
- The embedded UI now exposes graph, duplicates, daily memory, review queue actions, summaries, related items, tags, tag alias management, annotations, standalone and linked notes, saved searches, cited answer mode with standalone note citations, read state, review completion, analytics signals, and visible processing status.
