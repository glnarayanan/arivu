...
This directory contains codebase documentation for developers and AI assistants.
Durable runbooks, policies, status, and design context live in
`../documentation/`.
...
|   `-- secrets/                # Secret encryption and runtime settings management
